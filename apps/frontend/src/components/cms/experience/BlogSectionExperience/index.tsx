...
import {
  ...
  type BlogSectionExperienceDataFragment,
 ...
 */
export const BlogSectionExperienceExperience: CmsComponent<
  BlogSectionExperienceDataFragment
...
BlogSectionExperienceExperience.displayName =
  "Blog/News Section (Experience/BlogSectionExperience)";
BlogSectionExperienceExperience.getDataFragment = () => [
  "BlogSectionExperienceData",
  BlogSectionExperienceDataFragmentDoc,
];
BlogSectionExperienceExperience.getMetaData = async (
  contentLink,
  locale,
  client,
) => {
